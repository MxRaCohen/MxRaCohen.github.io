...
BLOG_AUTHOR = "Ra Cohen"  # (translatable)
BLOG_TITLE = "Mx. Ra Cohen"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://MxRaCohen.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://MxRaCohen.github.io/"
BLOG_EMAIL = "blog@racohen.org"
BLOG_DESCRIPTION = "My personal webpage."  # (translatable)
